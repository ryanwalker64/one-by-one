...
const variants =  {
    ...
    notComplete: {textDecoration: 'overline'}
}



function FocusScreen({task, completePriority, colors}) {
    ...
    return (
        ...
        className="">
            ...
            //  variants={variants}
             ...
             font-[700] text-5xl mb-10 relative inline-block`}>
                {task.text}
            </motion.h1>
            <p onClick={handleCompletion} className="flex gap-1 items-center font-thin text-xl">complete
              <span>
